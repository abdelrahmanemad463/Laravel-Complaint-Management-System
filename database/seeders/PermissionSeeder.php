...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $support = Role::firstOrCreate(['name' => 'Customer Support', 'guard_name' => 'web']); $support->syncPermissions(Permission::whereIn('name', ['customer.view','customer.create','customer.update','complaint.view','complaint.create','complaint.update','visit.view','visit.create','visit.update','visit.submit'])->get());
        $viewer = Role::firstOrCreate(['name' => 'Viewer', 'guard_name' => 'web']); $viewer->syncPermissions(Permission::whereIn('name', ['customer.view','complaint.view','branch.view','service.view','source.view','category.view','type.view','priority.view','status.view','report.view','visit.view'])->get());
