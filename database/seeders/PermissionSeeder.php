...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $qualityManager = Role::firstOrCreate(['name' => 'Quality Manager', 'guard_name' => 'web']); $qualityManager->syncPermissions(Permission::whereIn('name', ['visit.view','visit.create','visit.update','visit.submit','visit.review','visit.master.view','report.view','dashboard.view','dashboard.visitors.view'])->get());
        $support = Role::firstOrCreate(['name' => 'Customer Support', 'guard_name' => 'web']); $support->syncPermissions(Permission::whereIn('name', ['customer.view','customer.create','customer.update','complaint.view','complaint.create','complaint.update','visit.view','visit.create','visit.update','visit.submit','dashboard.view'])->get());
