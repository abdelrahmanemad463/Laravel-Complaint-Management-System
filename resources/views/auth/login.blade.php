@extends('layouts.app')
@section('content')
<div class="mx-3 sm:mx-auto mt-8 sm:mt-12 max-w-md rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
    <div class="mb-8"><p class="text-sm font-semibold uppercase tracking-wider text-indigo-600">{{ __('common.application_name') }}</p><h1 class="mt-2 text-2xl font-bold">{{ __('common.sign_in') }}</h1><p class="mt-2 text-sm text-slate-500">{{ __('common.sign_in_help') }}</p></div>
