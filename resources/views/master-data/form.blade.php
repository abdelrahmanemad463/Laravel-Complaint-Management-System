...
<form method="POST" action="{{ $editing ? route('master.update', [$type, $record->id]) : route('master.store', $type) }}" class="card max-w-2xl space-y-5">
    @csrf
    ...
    <div class="flex justify-end gap-3">
        <a class="btn-secondary" href="{{ route('master.index', $type) }}">{{ __('common.cancel') }}</a>
